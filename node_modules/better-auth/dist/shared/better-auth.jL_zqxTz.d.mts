...
import { a as OAuthProvider, S as SocialProviders, b as SocialProviderList, O as OAuth2Tokens } from './better-auth.BFod4hxi.mjs';
...
declare const createInternalAdapter: (adapter: Adapter, ctx: {
    ...
    createAccount: <T extends Record<string, any>>(account: Omit<Account, "id" | "createdAt" | "updatedAt"> & Partial<Account> & T, context?: GenericEndpointContext) => Promise<T & {
        id: string;
        providerId: string;
        accountId: string;
        userId: string;
...
export { setCookieToHeader as D, betterAuth as L, init as P, requestPasswordReset as a$, levels as a1, shouldPublishLog as a2, createLogger as a6, logger as a7, createInternalAdapter as a9, mergeSchema as aA, createCookieGetter as aB, getCookies as aC, setCookieCache as aE, setSessionCookie as aF, deleteSessionCookie as aG, parseCookies as aH, getSessionCookie as aJ, getCookieCache as aK, parseSetCookieHeader as aL, getEndpoints as aM, router as aN, signInSocial as aO, signInEmail as aP, callbackOAuth as aQ, getSession as aR, getSessionFromCtx as aS, sessionMiddleware as aT, requestOnlySessionMiddleware as aU, freshSessionMiddleware as aV, listSessions as aW, revokeSession as aX, revokeSessions as aY, revokeOtherSessions as aZ, signOut as a_, createFieldAttribute as ac, getAuthTables as al, accountSchema as am, userSchema as an, sessionSchema as ao, verificationSchema as ap, parseOutputData as aq, getAllFields as ar, parseUserOutput as as, parseAccountOutput as at, parseSessionOutput as au, parseInputData as av, parseUserInput as aw, parseAdditionalUserInput as ax, parseAccountInput as ay, parseSessionInput as az, forgetPassword as b0, requestPasswordResetCallback as b1, forgetPasswordCallback as b2, resetPassword as b3, createEmailVerificationToken as b4, sendVerificationEmailFn as b5, sendVerificationEmail as b6, verifyEmail as b7, updateUser as b8, changePassword as b9, setPassword as ba, deleteUser as bb, deleteUserCallback as bc, changeEmail as bd, error as be, ok as bf, signUpEmail as bg, listUserAccounts as bh, linkSocialAccount as bi, unlinkAccount as bj, getAccessToken as bk, refreshToken as bl, accountInfo as bm, originCheckMiddleware as bn, originCheck as bo, BASE_ERROR_CODES as f, createAuthMiddleware as j, createAuthEndpoint as k, optionsMiddleware as o, checkPassword as s };
export type { InferSessionAPI as $, AdapterDebugLogs as A, BetterAuthOptions as B, CreateCustomAdapter as C, TelemetryEvent as E, FilterActions as F, GenericEndpointContext as G, HookEndpointContext as H, InferOptionSchema as I, FieldAttribute as J, KyselyDatabaseType as K, Models as M, AdditionalSessionFieldsInput as N, Account as O, Where as Q, RateLimit as R, Session as S, TelemetryContext as T, User as U, Verification as V, WithJsDoc as W, AdapterSchemaCreation as X, AdapterInstance as Y, SecondaryStorage as Z, FilteredAPI as _, Adapter as a, LogLevel as a0, Logger as a3, LogHandlerParams as a4, InternalLogger as a5, FieldType as a8, BetterAuthCookies as aD, EligibleCookies as aI, InternalAdapter as aa, FieldAttributeConfig as ab, InferValueType as ad, InferFieldsOutput as ae, InferFieldsInput as af, InferFieldsInputClient as ag, FieldAttributeToObject as ah, InferAdditionalFieldsFromPluginOptions as ai, PluginFieldAttribute as aj, BetterAuthDbSchema as ak, AdapterConfig as b, CustomAdapter as c, CleanedWhere as d, AdapterTestDebugLogs as e, AuthPluginSchema as g, BetterAuthPlugin as h, InferPluginErrorCodes as i, AuthEndpoint as l, AuthMiddleware as m, Auth as n, AuthContext as p, InferUser as q, InferSession as r, InferAPI as t, AdditionalSessionFieldsOutput as u, AdditionalUserFieldsOutput as v, InferFieldsFromPlugins as w, InferFieldsFromOptions as x, AdditionalUserFieldsInput as y, InferPluginTypes as z };
