...
const socialProviders_index = require('./better-auth.Bx3RgYZf.cjs');
...
const schema = require('./better-auth.DKORdAr4.cjs');
const cookies_index = require('../cookies/index.cjs');
require('./better-auth.CXhVNgXP.cjs');
const hasPermission = require('./better-auth.D7N9YNr5.cjs');
const toZod = require('./better-auth.BT1jd5k2.cjs');
...
const createInvitation = (option) => {
  const additionalFieldsSchema = toZod.toZodSchema({
...
const acceptInvitation = (options) => socialProviders_index.createAuthEndpoint(
  "/organization/accept-invitation",
  {
    method: "POST",
    body: z__namespace.object({
      invitationId: z__namespace.string().meta({
...
const rejectInvitation = (options) => socialProviders_index.createAuthEndpoint(
...
const cancelInvitation = (options) => socialProviders_index.createAuthEndpoint(
...
const getInvitation = (options) => socialProviders_index.createAuthEndpoint(
...
const listInvitations = (options) => socialProviders_index.createAuthEndpoint(
...
const listUserInvitations = (options) => socialProviders_index.createAuthEndpoint(
...
const addMember = (option) => {
  ...
  const baseSchema = z__namespace.object({
    ...
    role: z__namespace.union([z__namespace.string(), z__namespace.array(z__namespace.string())]).meta({
  ...
  return socialProviders_index.createAuthEndpoint(
    ...
    async (ctx) => {
      const session = ctx.body.userId ? await socialProviders_index.getSessionFromCtx(ctx).catch((e) => null) : null;
      ...
      if (!user) {
        throw new betterCall.APIError("BAD_REQUEST", {
          message: socialProviders_index.BASE_ERROR_CODES.USER_NOT_FOUND
        });
      }
      const alreadyMember = await adapter.findMemberByEmail({
        email: user.email,
...
const removeMember = (options) => socialProviders_index.createAuthEndpoint(
  "/organization/remove-member",
  {
    method: "POST",
    body: z__namespace.object({
      memberIdOrEmail: z__namespace.string().meta({
...
const updateMemberRole = (option) => socialProviders_index.createAuthEndpoint(
  "/organization/update-member-role",
  {
    ...
    body: z__namespace.object({
      ...
      memberId: z__namespace.string().meta({
...
const getActiveMember = (options) => socialProviders_index.createAuthEndpoint(
...
const leaveOrganization = (options) => socialProviders_index.createAuthEndpoint(
  "/organization/leave",
  {
    method: "POST",
    body: z__namespace.object({
    ...
    requireHeaders: true,
    use: [socialProviders_index.sessionMiddleware, schema.orgMiddleware]
  },
  async (ctx) => {
    const session = ctx.context.session;
    const adapter = getOrgAdapter(ctx.context, options);
...
const listMembers = (options) => socialProviders_index.createAuthEndpoint(
...
const checkOrganizationSlug = (options) => socialProviders_index.createAuthEndpoint(
  "/organization/check-slug",
  {
    ...
    use: [socialProviders_index.requestOnlySessionMiddleware, schema.orgMiddleware]
  },
  async (ctx) => {
...
const getFullOrganization = (options) => socialProviders_index.createAuthEndpoint(
...
const listOrganizations = (options) => socialProviders_index.createAuthEndpoint(
  "/organization/list",
  {
    method: "GET",
    use: [schema.orgMiddleware, schema.orgSessionMiddleware],
...
const removeTeam = (options) => socialProviders_index.createAuthEndpoint(
...
const listOrganizationTeams = (options) => socialProviders_index.createAuthEndpoint(
...
const setActiveTeam = (options) => socialProviders_index.createAuthEndpoint(
...
const listUserTeams = (options) => socialProviders_index.createAuthEndpoint(
...
const listTeamMembers = (options) => socialProviders_index.createAuthEndpoint(
...
const addTeamMember = (options) => socialProviders_index.createAuthEndpoint(
...
const removeTeamMember = (options) => socialProviders_index.createAuthEndpoint(
...
const organization = (options) => {
  ...
  const api = shimContext(endpoints, {
    ...
    getSession: async (context) => {
      return await socialProviders_index.getSessionFromCtx(context);
    }
  });
  return {
    id: "organization",
    endpoints: {
      // ...endpoints,
      ...api,
      hasPermission: socialProviders_index.createAuthEndpoint(
          ...
          body: z__namespace.object({
            ...
            z__namespace.union([
              z__namespace.object({
                ...
                permissions: z__namespace.undefined()
              }),
              z__namespace.object({
                permission: z__namespace.undefined(),
                permissions: z__namespace.record(z__namespace.string(), z__namespace.array(z__namespace.string()))
              })
            ])
          ),
