import { h as BetterAuthPlugin, B as BetterAuthOptions, ag as InferFieldsInputClient, ae as InferFieldsOutput, U as User, S as Session, n as Auth } from './better-auth.jL_zqxTz.mjs';
import { BetterFetchOption, BetterFetchResponse, BetterFetch, BetterFetchPlugin } from '@better-fetch/fetch';
import { WritableAtom, Atom } from 'nanostores';
import { U as UnionToIntersection, H as HasRequiredKeys, a as Prettify, L as LiteralString, S as StripEmptyObjects } from './better-auth.BDR52Rf2.mjs';
...
type InferActions<O extends ClientOptions> = (O["plugins"] extends Array<infer Plugin> ? UnionToIntersection<Plugin extends BetterAuthClientPlugin ? Plugin["getActions"] extends (...args: any) => infer Actions ? Actions : {} : {}> : {}) & InferRoutes<O["$InferAuth"] extends {
...
export type { AtomListener as A, BetterAuthClientPlugin as B, ClientOptions as C, IsSignal as I, Store as S, InferClientAPI as a, InferActions as b, InferErrorCodes as c, InferRoute as d, InferPluginsFromClient as e, InferSessionFromClient as f, InferUserFromClient as g, InferAdditionalFromClient as h };
