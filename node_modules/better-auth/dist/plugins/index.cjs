...
const organization = require('../shared/better-auth.kvWPdS5e.cjs');
...
const admin = require('../shared/better-auth.Bv6xc9eQ.cjs');
...
const plugins_oidcProvider_index = require('../shared/better-auth.CX5ucYKP.cjs');
const plugins_captcha_index = require('./captcha/index.cjs');
const plugins_oneTimeToken_index = require('../shared/better-auth.DBscO_L1.cjs');
...
require('../shared/better-auth.DKORdAr4.cjs');
...
const mcp = (options) => {
  ...
  return {
    ...
    endpoints: {
      getMcpOAuthConfig: socialProviders_index.createAuthEndpoint(
      ...
      mcpOAuthAuthroize: socialProviders_index.createAuthEndpoint(
        "/mcp/authorize",
        {
          method: "GET",
      ...
      mcpOAuthToken: socialProviders_index.createAuthEndpoint(
        "/mcp/token",
        {
          method: "POST",
      ...
      registerMcpClient: socialProviders_index.createAuthEndpoint(
        "/mcp/register",
        {
          method: "POST",
      ...
      getMcpSession: socialProviders_index.createAuthEndpoint(
        "/mcp/get-session",
        {
          method: "GET",
          requireHeaders: true
